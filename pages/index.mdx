...
First you'll need the _`OPENAI_API_KEY`_.

You need to sign up and visit your [API keys page](https://platform.openai.com/account/api-keys) to get it.
...
_`model`_ is a required field, the name of the model to use. If you don't care about the model right now, start with `gpt-3.5-turbo-0613`.
